...
public class WaveView extends LinearLayout {
    ...
    private final int DEFAULT_ABOVE_WAVE_COLOR = this.getResources().getColor(R.color.deepskyblue);
    private final int DEFAULT_BLOW_WAVE_COLOR = this.getResources().getColor(R.color.deepskyblue);
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        mWaveMultiple = attributes.getInt(R.styleable.WaveView_wave_length, LITTLE);
        mWaveHz = attributes.getInt(R.styleable.WaveView_wave_hz, LARGE);
        attributes.recycle();
